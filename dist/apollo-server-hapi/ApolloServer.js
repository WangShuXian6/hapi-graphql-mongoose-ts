...
function handleFileUploads(uploadsConfig) {
    return (request, _h) => __awaiter(this, void 0, void 0, function* () {
        if (typeof apollo_server_core_2.processFileUploads === 'function' && request.mime === 'multipart/form-data') {
                ...
                method: function (request, h) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (this.playgroundOptions && request.method === 'get') {
                            ...
                            const prefersHTML = types.find((x) => x === 'text/html' || x === 'application/json') ===
                                'text/html';
                            if (prefersHTML) {
                                const playgroundRenderPageOptions = Object.assign({ endpoint: path, 
                                    // @ts-ignore TODO: https://github.com/apollographql/apollo-server/pull/3273
                                    subscriptionEndpoint: this.subscriptionsPath, 
                                    // @ts-ignore TODO: https://github.com/apollographql/apollo-server/pull/3273
                                    version: this.playgroundVersion }, this.playgroundOptions);
                                return h
